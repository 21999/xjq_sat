# Examples:
# bash scripts/train_transfer_policy.sh sat adroit_hammer 0322 0 0
...
python train_transfer.py --config-name=${config_name}.yaml \
                            task=${task_name} \
                            ...
                            task.dataset.max_train_episodes=10
