...
class SequenceSampler:
    ...
    def sample_sequence(self, idx):
        buffer_start_idx, buffer_end_idx, sample_start_idx, sample_end_idx, ep_idx, offset \
            = self.indices[idx]
        ...
        # relative timestep within episode
        rel_t = (buffer_start_idx - ep_start) / (ep_end - ep_start)
        ...
        cA, cD = pywt.dwt(result['action'], 'db4', axis=0)
