...
import tqdm
import time
from sat.env import AdroitEnv
from sat.gym_util.mjpc_diffusion_wrapper import MujocoPointcloudWrapperAdroit
...
class AdroitRunner(BaseRunner):
    ...
    def run(self, policy: BasePolicy, vqvae=None):
        ...
        if total_predict_time > 0:
            log_data['policy_predict_fps'] = total_predict_calls / total_predict_time
        else:
            log_data['policy_predict_fps'] = 0.0
